...
#include FT_TRUETYPE_DRIVER_H   // <freetype/ftttdrv.h>
...
bool ImGuiFreeType::BuildFontAtlas(ImFontAtlas* atlas, unsigned int extra_flags)
{
    ...
    unsigned int interpreter_version = TT_INTERPRETER_VERSION_35;
    FT_Property_Set(ft_library, "truetype", "interpreter-version", &interpreter_version);

    FT_Bool no_darkening = 0;
    FT_Property_Set(ft_library, "cff", "no-stem-darkening", &no_darkening);
    FT_Property_Set(ft_library, "autofit", "no-stem-darkening", &no_darkening);
